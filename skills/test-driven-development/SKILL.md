...
- **Direct (single-agent) mode (default):** write the failing test and the
...
**Always (for core logic — see Test Focus):**
- New features
- Bug fixes
- Refactoring
- Behavior changes
...
Write tests for core logic — complex business rules, algorithms, and
error-prone state transitions. Do not write tests for simple CRUD,
DTO/POJO boilerplate, glue code, or configuration.
...
| Excuse | Reality |
|--------|---------|
| "Too simple to test" | Simple core logic breaks too; the test takes 30 seconds. (Applies to core logic — see Test Focus.) |
...
| "Existing code has no tests" | You're improving it. Add tests for existing core logic (see Test Focus). |
...
- [ ] Every new function/method that implements core logic has a test (see Test Focus)
