...
```text
Subagent (fixer): "Fix agent-tool-abort.test.ts failures"
Subagent (fixer): "Fix batch-completion-behavior.test.ts failures"
Subagent (fixer): "Fix tool-approval-race-conditions.test.ts failures"
